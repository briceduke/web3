...
export const abi: AbiItem[] = [
	...
	},
	{
		...
		outputs: [
			{
				internalType: 'contract HEDGEDividendTracker',
				name: '',
				type: 'address',
			},
		],
	...
	},
	{
		...
		name: 'updateCanJumpLimitOnWallet',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
	},
